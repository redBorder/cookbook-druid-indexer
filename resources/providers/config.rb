  ...
  begin
    ...
    base_tasks = [
      { task_name: 'rb_monitor', feed: 'rb_monitor',
        dimensions: [],
        dimensions_exclusions: ["unit", "type", "value"],
        metrics: [
      ...
      { task_name: 'rb_state', feed: 'rb_state_post',
        dimensions: ["wireless_station", "type", "wireless_channel", "wireless_tx_power", "wireless_admin_state", "wireless_op_state", 
      ...
      { task_name: 'rb_flow', feed: 'rb_flow_post', 
        dimensions: ["application_id_name", "building", "building_uuid", "campus", "campus_uuid", "client_accounting_type", 
        ...
        "ti_indicators", "wireless_operator", "wireless_station", "zone", "zone_uuid"], 
        dimensions_exclusions: ["bytes", "pkts", "flow_end_reason", "first_switched", "wan_ip_name",], 
        metrics: [
          { type: "count", name: "events" },
      ...
      { task_name: 'rb_event', feed: 'rb_event_post', 
        dimensions: ["src", "src_is_malicious", "dst", "dst_is_malicious", "sensor_uuid", "src_port", "dst_port", "src_as_name", "src_country_code",
        ...
        dimensions_exclusions: ["payload"],
        metrics: [
          { type: "count", name: "events" },
          { type: "hyperUnique", name: "signatures", fieldName: "msg" }
        ]},
      { task_name: 'rb_vault', feed: 'rb_vault_post',
        dimensions: ["pri", "pri_text", "syslogfacility", "syslogfacility_text", "syslogseverity", "syslogseverity_text", "hostname", "fromhost_ip", 
        ...
        "alarm_user", "alarm_severity", "traffic_lan_ip", "traffic_wan_ip", "intrusion_source", "intrusion_target", "wireless_station", 
        "asset_ip_address", "asset_mac_address"],
        dimensions_exclusions: ["unit", "type", "valur"],
        metrics: [
          { type: "count", name: "events" }
        ]},
      ...
      { task_name: 'rb_location', feed: 'rb_loc_post', 
        dimensions: ["location_id", "latitude", "longitude", "address", "city", "region", "country", "postal_code", "sensor_name", "sensor_uuid", 
      ...
      { task_name: 'rb_wireless', feed: 'rb_wireless', 
        dimensions: ["wireless_station", "type", "wireless_channel", "wireless_tx_power", "wireless_admin_state", "wireless_op_state", "wireless_mode", 
